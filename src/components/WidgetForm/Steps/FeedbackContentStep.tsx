...
export function FeedbackContentStep({ feedbackType, onFeedbackTypeRestartedRequested, onFeedbackSent }: FeedbackContentStepProps) {
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmitFeedback} className="m-4 w-full">
                ...
                focus:border-t-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none scrollbar-thumb-zinc-700 scrollbar-track-transparent"
